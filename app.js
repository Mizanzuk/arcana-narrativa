...
const sources={
 ...
 kaplan:{title:'Aryeh Kaplan (1937–1983) – Sefer Yetzirah: The Book of Creation, introdução e comentário',book:true,pdf:'Sefer Yetzirah The Book of Creation – In Theory and Practice (Aryeh Kaplan) (z-library.sk, 1lib.sk, z-lib.sk).pdf'},
 mathers:{title:'S. L. MacGregor Mathers (1854–1918) – The Kabbalah Unveiled, introdução',book:true,pdf:'The Kabbalah Unveiled (S.L. MacGregor Mathers).pdf'},
 scholem:{title:'Gershom Scholem (1897–1982) – The Name of God and the Linguistic Theory of the Kabbala',url:'https://www.cambridge.org/core/journals/diogenes/article/abs/name-of-god-and-the-linguistic-theory-of-the-kabbala/B1DA5BD235C3C07683B46084CC4DEF48'},
 cabalaHistory:{title:'Harvard Theological Review – On Practical Uses of Ten Sefirot',url:'https://www.cambridge.org/core/journals/harvard-theological-review/article/on-practical-uses-of-ten-sefirot-material-readings-in-an-early-modern-kabbalistic-collectaneum-ms-michael-473/7AFD1E4DD68EF23C1F732EAA63ACDC32'},
...
const bookPages={
 18:[['kaplan','Dez sefirot e 22 letras no Sefer Yetzirah.'],['scholem','A linguagem da criação na Cabala judaica.']],
 19:[['kaplan','O texto antigo e suas leituras posteriores.'],['mathers','A releitura ocultista ocidental.'],['fortune','A Árvore na Cabala hermética.']],
 20:[['fortune','Os 22 caminhos no diagrama hermético.'],['crowleyPaths','Trunfos e letras no Thoth.']],
 21:[['crowleySuits','Naipes e elementos.'],['crowleyNumbers','Números e sephiroth.']],
 22:[['mathers','Gematria e cálculo das letras.'],['fortuneGematria','Valores numéricos das letras.']],
 23:[['crowleyNumbers','Dez sephiroth e cartas numeradas.'],['crowleySwords','Dez de Espadas.']],
 ...
 31:[['fortune','Relações da Árvore.'],['crowleyPaths','Cartas, letras e planetas.']],
...
Object.assign(bookPages,{
 18:[['kaplan','Dez sefirot e 22 letras no Sefer Yetzirah.'],['scholem','Linguagem e criação na Cabala judaica.']],
 19:[['kaplan','O texto antigo e suas interpretações.'],['mathers','A leitura ocultista ocidental.'],['fortune','A Árvore na Cabala hermética.']],
 20:[['fortune','Os 22 caminhos no diagrama hermético.'],['crowleyPaths','Trunfos e letras no Thoth.']],
 21:[['crowleySuits','Naipes e elementos.'],['crowleyNumbers','Números e sephiroth.']],
 22:[['mathers','Introdução à gematria.'],['fortuneGematria','Valores numéricos das letras.']],
 23:[['crowleyNumbers','Dez sephiroth e cartas numeradas.'],['crowleySwords','Dez de Espadas.']],
 24:[['crowleyAleph','Aleph e o Louco.']],25:[['crowleyTitle','Crédito de Harris e edição do livro.']],
 26:[['crowleyCups','Imagem, título e atribuição.']],27:[['crowleyCups','Dois de Copas e seus elementos visuais.']],
 28:[['crowleyCups','Dois de Copas: Vênus em Câncer.']],29:[['crowleySwords','Dois de Espadas: Lua em Libra e rosa azul.']],
 30:[['crowleyDecans','Decanatos nas cartas menores.']],31:[['fortune','Relações da Árvore.'],['crowleyPaths','Cartas, letras e planetas.']],
 32:[['crowleyPriestess','A Sacerdotisa, Gimel e Lua.']],33:[['fortune','Estrutura da Árvore.'],['crowleyTree','Dez sephiroth e 22 caminhos.']]
});
const enrich={
...
Object.assign(enrich,{
 4:{title:'Duas narrativas.\nDuas perguntas.',lede:'O que os documentos mostram? O que a leitura esotérica passou a imaginar?',special:'origins'},
 5:{title:'As cartas\nvieram primeiro.',lede:'Os objetos do século XV mostram um jogo de naipes e trunfos no norte da Itália.',visual:'visconti-world.webp'},
 6:{title:'Uma história\nem camadas.',lede:'O jogo, a cartomancia e as correspondências surgem em momentos diferentes.',special:'timeline'},
 7:{title:'Do jogo\nà leitura.',lede:'O uso como trunfo é anterior à leitura simbólica. O Marselha é uma tradição visual posterior.',visual:'marseille-magician.webp'},
 12:{title:'O Mago em\ntrês baralhos.',lede:'Clique em uma carta para ver sua história, seus detalhes e o que muda de um deck para outro.',special:'compare'},
 14:{title:'Etteilla cria\num tarô para ler.',lede:'78 cartas, quatro naipes, nova ordem e um livreto: um sistema concebido para cartomancia.',visual:'etteilla-astres.webp'},
 15:{title:'Éliphas Lévi\ne a nova ponte.',lede:'Lévi (1810–1875) aproxima 22 trunfos e 22 letras no ocultismo do século XIX.',visual:'tree-kircher.webp'},
 16:{title:'A Golden Dawn\norganiza relações.',lede:'A ordem fundada em 1888 articula tarô, Cabala hermética, letras e astrologia.',visual:'rose-cross.webp'},
 17:{title:'Quatro linguagens.\nUma de cada vez.',lede:'Imagem, mapa, número das letras e qualidades astrológicas serão aprendidos antes de se cruzarem.',visual:'thoth-spread.webp'},
 18:{title:'O que é\na Cabala?',lede:'Uma tradição judaica de interpretação da criação, de Deus e das Escrituras, com muitas vertentes.',visual:'tree-kircher.webp'},
 19:{title:'Origem contada.\nOrigem estudada.',lede:'A narrativa de revelação e a história medieval respondem a perguntas diferentes.',visual:'tree-kircher.webp'},
 20:{title:'22 letras.\n22 caminhos.',lede:'Toque em uma letra: veja seu valor, a passagem que ela marca e a carta associada.',special:'paths'},
 21:{title:'Quatro naipes.\nQuatro elementos.',lede:'Clique em uma carta. Compare como o mesmo número muda entre Água, Ar, Fogo e Terra.',special:'suits'},
 22:{title:'Uma palavra.\nUma soma em hebraico.',lede:'“Amor” → אהבה → 1 + 5 + 2 + 5 = 13. Veja a conta e compare palavras de mesmo valor.',special:'gematria'},
 23:{title:'O número marca\numa posição.',lede:'Do Ás ao Dez, a posição se repete; cada naipe e cada imagem a transformam.',special:'numbers'},
 24:{title:'Aleph não é\no número do Louco.',lede:'א vale 1; o Louco é 0. A associação entre eles é simbólica.',visual:'thoth/Thot-T-00.webp'},
 25:{title:'Crowley +\nFrieda Harris.',lede:'O sistema descrito por Crowley (1875–1947) ganha forma nas pinturas de Harris (1877–1962).',visual:'thoth-spread.webp'},
 26:{title:'Três passos\npara ler uma carta.',lede:'Descreva o que vê. Consulte uma relação. Transforme-a em gesto ou consequência.',visual:'thoth/Thot-C-02.webp'},
 27:{title:'Dois de Copas.\nO que se vê?',lede:'Duas taças, circulação de água e simetria: observe o encontro antes de nomear a carta.',visual:'thoth/Thot-C-02.webp'},
 28:{title:'Dois de Copas.\nO que se acrescenta?',lede:'Água, Chokmah e Vênus em Câncer ampliam a imagem de troca e acolhimento.',visual:'thoth/Thot-C-02.webp'},
 29:{title:'Dois de Espadas.\nLua em Libra.',lede:'A paz desta carta exige ajuste: duas lâminas se equilibram sob uma qualidade lunar.',visual:'thoth/Thot-S-02.webp'},
 30:{title:'O céu acrescenta\num clima.',lede:'Compare Mercúrio no Mago, Lua na Sacerdotisa e os decanos das cartas numeradas.',visual:'thoth/Thot-T-01.webp'},
 31:{title:'Laboratório de\ncorrespondências.',lede:'Escolha letra, elemento e planeta para descobrir relações, cartas e perguntas de escrita.',special:'sandbox'},
 32:{title:'Sacerdotisa.\nGimel. Lua.',lede:'Carta II, letra ג de valor 3, caminho Kether–Tiphereth e um ritmo lunar.',visual:'thoth/Thot-T-02.webp'},
 33:{title:'A Árvore da Vida',lede:'Explore todas as relações no mapa, em camadas e em tela cheia.',special:'tree'},
 34:{title:'Do mapa\nà cena.',lede:'Uma associação só ganha vida quando altera gesto, tensão ou decisão.',visual:'thoth/Thot-T-14.webp'},
 35:{title:'Agora, escreva.',lede:'Uma imagem, uma pergunta e uma escolha concreta.',visual:'hero.webp'}
});
const exercises=[
 {id:'uma',title:'Uma carta',subtitle:'Um personagem em movimento',count:1,positions:['Personagem'],theory:['Descreva antes de interpretar.','Pergunte o que a figura quer e o que se recusa a ver.','Escolha uma resposta e transforme em ação.'],prompt:'Que gesto pequeno denuncia um desejo que o personagem ainda não consegue admitir?',visual:'one'},
...
function setAuthMode(mode){
 state.authMode=mode;visible('auth');$('#auth-form').reset();$('#auth-status').textContent='';
 const loginMode=mode==='login',passwordMode=mode==='password',resetMode=mode==='reset';
 $('#password-label').hidden=!loginMode;$('#auth-password').hidden=!loginMode;$('#auth-password').required=loginMode;
 $('#new-password-label').hidden=!passwordMode;$('#new-password').hidden=!passwordMode;$('#new-password').required=passwordMode;
 $('#confirm-password-label').hidden=!passwordMode;$('#confirm-password').hidden=!passwordMode;$('#confirm-password').required=passwordMode;
 $('#email-label').hidden=passwordMode;$('#auth-email').hidden=passwordMode;$('#auth-email').required=!passwordMode;
 $('#auth-switch').hidden=!(loginMode||resetMode);$('#auth-switch').textContent=resetMode?'Voltar ao login':'Esqueci minha senha';
 $('#auth-kicker').textContent=loginMode?'BEM-VINDA, BEM-VINDO':'ACESSO À OFICINA';
 $('#auth-title').textContent=loginMode?'Que bom ter você por aqui.':resetMode?'Vamos recuperar seu acesso.':mode==='request'?'Vamos localizar sua inscrição.':'Escolha uma senha.';
 $('#auth-desc').textContent=loginMode?'Entre com o e-mail usado na inscrição.':resetMode?'Enviaremos um link para você criar uma nova senha.':mode==='request'?'Vamos enviar um link de acesso para o e-mail usado na inscrição.':'Crie uma senha para entrar na oficina.';
 $('#auth-submit').innerHTML=loginMode?'Entrar <span>↗</span>':passwordMode?'Salvar senha <span>↗</span>':'Enviar instruções <span>↗</span>';
 const secure=location.protocol==='https:'||location.hostname==='127.0.0.1'||location.hostname==='localhost';
 $$('#auth-form input').forEach(input=>input.disabled=!secure);$('#auth-submit').disabled=!secure;
 if(!secure)$('#auth-status').textContent='O acesso estará disponível assim que a conexão segura for ativada. Volte em alguns minutos.';
 else (passwordMode?$('#new-password'):$('#auth-email')).focus({preventScroll:true});
}
...
async function handleAuth(event){event.preventDefault();const mode=state.authMode,status=$('#auth-status'),submit=$('#auth-submit');status.textContent='';submit.disabled=true;try{if(mode==='request'||mode==='reset'){const email=$('#auth-email').value.trim();if(!email)throw new Error('Informe o e-mail usado na inscrição.');await authRequest(email);status.textContent='Se encontrarmos uma inscrição com esse e-mail, as instruções chegarão em alguns minutos.'}
 ...
 else if(mode==='password'){const s=storageSession();const password=$('#new-password').value,confirmation=$('#confirm-password').value;if(password.length<10)throw new Error('Use uma senha com pelo menos 10 caracteres.');if(password!==confirmation)throw new Error('As senhas não coincidem. Confira os dois campos.');const r=await fetch(`${ARCANA_CFG.supabaseUrl}/auth/v1/user`,{method:'PUT',headers:{'Content-Type':'application/json','apikey':ARCANA_CFG.supabaseAnon,Authorization:`Bearer ${s?.access_token}`},body:JSON.stringify({password})});if(!r.ok)throw new Error('Não foi possível salvar a senha. Solicite um novo link.');$('#auth-status').textContent='Senha salva. Abrindo a oficina…';await resumeSession(s)}
...
function visualMarkup(n,path,caption=true){
 const labels={
  'hero.webp':'Cartas do Tarot de Thoth sobre uma mesa · fotografia de apresentação.',
  'visconti-world.webp':'O Mundo · baralho Visconti-Sforza, norte da Itália, século XV.',
  'marseille-magician.webp':'O Mago · Tarô de Marselha, tradição gráfica posterior às primeiras cartas italianas.',
  'rws-magician.webp':'O Mago · tarô Waite–Smith (1909), arte de Pamela Colman Smith (1878–1951).',
  'rws-3swords.webp':'Três de Espadas · tarô Waite–Smith (1909), arte de Pamela Colman Smith (1878–1951).',
  'etteilla-astres.webp':'Les Astres · baralho Grand Etteilla, exemplar histórico posterior ao sistema de Etteilla (1738–1791).',
  'rose-cross.webp':'Lámen Rosa-Cruz · emblema da Golden Dawn, fundada em 1888.',
  'tree-kircher.webp':'Árvore da Vida em diagrama de Athanasius Kircher (1602–1680), adaptação cristã.',
  'crowley.webp':'Retrato de Aleister Crowley (1875–1947).',
  'thoth-spread.webp':'Cartas do Tarot de Thoth · pinturas de Lady Frieda Harris (1877–1962).'
 };
 const code=path.startsWith('thoth/')?path.split('/').pop().replace('Thot-','').replace('.webp',''):null;
 const label=code?`${cardInfo(code).name} · Tarot de Thoth, pintura de Lady Frieda Harris (1877–1962).`:labels[path]||'Imagem de referência do tarô.';
 const src=imageUrl(path);if(!src)return '';
 const img=`<img src="${esc(src)}" alt="${esc(label)}" loading="lazy">`;
 return caption?`<figure class="illustrated-card">${img}<figcaption>${esc(label)}</figcaption></figure>`:img;
}
...
function suitsVisual(){
 const items=[['Paus · Fogo','thoth/Thot-W-02.webp','W'],['Copas · Água','thoth/Thot-C-02.webp','C'],['Espadas · Ar','thoth/Thot-S-02.webp','S'],['Discos · Terra','thoth/Thot-D-02.webp','D']];
...
function originsVisual(){return `<div class="origin-pair"><button type="button" data-origin="history"><b>HISTÓRIA DOCUMENTADA</b><span>Cartas italianas · século XV</span><small>Objetos, registros, regras de jogo</small></button><button type="button" data-origin="esoteric"><b>NARRATIVA ESOTÉRICA</b><span>Releituras · séculos XVIII–XX</span><small>Egito imaginado, letras e símbolos</small></button></div>`}
function timelineVisual(){return `<div class="course-timeline">${[['XV','Cartas italianas','Jogo'],['XVIII','Etteilla','Cartomancia'],['XIX','Lévi e Golden Dawn','Correspondências'],['XX','Waite–Smith e Thoth','Imagens modernas']].map(x=>`<div><b>${x[0]}</b><strong>${x[1]}</strong><span>${x[2]}</span></div>`).join('')}</div>`}
function pathsVisual(){const letters=['א','ב','ג','ד','ה','ו','ז','ח','ט','י','כ','ל','מ','נ','ס','ע','פ','צ','ק','ר','ש','ת'];const pt=i=>({x:150+(sefirot[i][1]-250)*.45,y:25+(sefirot[i][2]-55)*.44});const lines=paths.map((p,i)=>{const a=pt(p[1]),b=pt(p[2]),x=(a.x+b.x)/2,y=(a.y+b.y)/2;return `<g class="learning-path" data-path="${i}" tabindex="0" role="button" aria-label="${esc(p[0])}: ${esc(sefirot[p[1]][0])} a ${esc(sefirot[p[2]][0])}, ${esc(majorNames[p[3]])}"><line x1="${a.x}" y1="${a.y}" x2="${b.x}" y2="${b.y}"/><circle cx="${x}" cy="${y}" r="11"/><text x="${x}" y="${y+5}" lang="he">${letters[i]}</text></g>`}).join('');const nodes=sefirot.map((q,i)=>{const v=pt(i);return `<g class="learning-node"><circle cx="${v.x}" cy="${v.y}" r="14"/><text x="${v.x}" y="${v.y+3}">${i+1}</text></g>`}).join('');return `<div class="paths-learning"><svg viewBox="0 0 300 440" role="img" aria-label="Dez centros da Árvore ligados por 22 caminhos com letras hebraicas">${lines}${nodes}</svg><div class="paths-side"><p>Toque em uma letra no mapa ou nesta lista para ver caminho, valor e carta.</p><div class="paths-list">${paths.map((x,i)=>`<button type="button" data-path="${i}" title="${esc(x[0])} · ${esc(majorNames[x[3]])}"><strong lang="he">${letters[i]}</strong><span>${esc(x[0])}</span></button>`).join('')}</div><small>O mapa completo está no slide 33.</small></div></div>`}
function sandboxVisual(){return `<div class="sandbox"><div class="sandbox-choices"><label>Letra ou caminho<select id="sandbox-letter"><option value="">Qualquer letra</option>${paths.map((x,i)=>`<option value="${i}">${esc(x[0])} · ${esc(majorNames[x[3]])}</option>`).join('')}</select></label><label>Sephirah / número<select id="sandbox-sephirah"><option value="">Qualquer centro</option>${sefirot.map((x,i)=>`<option value="${i+1}">${i+1} · ${esc(x[0])}</option>`).join('')}</select></label><label>Elemento<select id="sandbox-element"><option value="">Qualquer elemento</option><option>Fogo</option><option>Água</option><option>Ar</option><option>Terra</option></select></label><label>Planeta<select id="sandbox-planet"><option value="">Qualquer planeta</option>${['Sol','Lua','Mercúrio','Vênus','Marte','Júpiter','Saturno'].map(x=>`<option>${x}</option>`).join('')}</select></label></div><div id="sandbox-result" class="sandbox-result" aria-live="polite"></div></div>`}
...
function showSlide(){
 ...
 const d=list[state.idx],n=d.number,extra=enrich[n]||{};window.ArcanaTree?.configure(treeConfig());
...
function detailForSlide(n){const d=state.slides.find(x=>x.number===n);if(!d)return;let body=`<p>${esc(d.detail||'Observe a imagem e procure uma pergunta de escrita.')}</p>`;if(n===18)body+='<p><b>Não confunda:</b> as dez sefirot do Sefer Yetzirah não são idênticas às dez emanações nomeadas da Cabala medieval. A Árvore usada no tarô hermético é uma reorganização posterior.</p>';if(n===22)body+='<p>O cálculo exige uma palavra hebraica escolhida com cuidado. Palavras portuguesas podem ter mais de uma tradução; por isso esta oficina usa um conjunto pequeno de equivalências explícitas.</p>';const links=makeLinks(n,d.sources||[]);openKnowledge(enrich[n]?.title?.replace(/\n/g,' ')||slideCopy[n]?.[0]||d.title,body,links,sectionLabel(n))}
function renderTree(){return '<div id="tree-anchor" class="tree-anchor"></div>'}
function treeConfig(){return {sefirot,paths,majorNames,majors,cardInfo,mediaCard,openKnowledge,sources}}
function bindTree(){window.ArcanaTree.setup(treeConfig())}
const gematriaValues={'א':1,'ב':2,'ג':3,'ד':4,'ה':5,'ו':6,'ז':7,'ח':8,'ט':9,'י':10,'כ':20,'ך':20,'ל':30,'מ':40,'ם':40,'נ':50,'ן':50,'ס':60,'ע':70,'פ':80,'ף':80,'צ':90,'ץ':90,'ק':100,'ר':200,'ש':300,'ת':400};
const hebrewWords=[
 {pt:'amor',he:'אהבה',read:'ahavá',sense:'amor'}, {pt:'um',he:'אחד',read:'echád',sense:'um; unidade'},
 {pt:'vida',he:'חיים',read:'chayím',sense:'vida'}, {pt:'paz',he:'שלום',read:'shalóm',sense:'paz'},
 {pt:'luz',he:'אור',read:'or',sense:'luz'}, {pt:'casa',he:'בית',read:'báyit',sense:'casa'},
 {pt:'agua',he:'מים',read:'máyim',sense:'água'}, {pt:'fogo',he:'אש',read:'esh',sense:'fogo'},
 {pt:'terra',he:'ארץ',read:'érets',sense:'terra'}, {pt:'ceu',he:'שמים',read:'shamáyim',sense:'céu'},
 {pt:'caminho',he:'דרך',read:'dérek',sense:'caminho'}, {pt:'palavra',he:'מילה',read:'milá',sense:'palavra'},
 {pt:'verdade',he:'אמת',read:'emét',sense:'verdade'}, {pt:'sabedoria',he:'חכמה',read:'chokhmá',sense:'sabedoria'},
 {pt:'beleza',he:'תפארת',read:'tiféret',sense:'beleza'}, {pt:'rei',he:'מלך',read:'mélekh',sense:'rei'}
];
const hebrewLetterNames={'א':'Aleph','ב':'Bet','ג':'Gimel','ד':'Dalet','ה':'He','ו':'Vav','ז':'Zayin','ח':'Chet','ט':'Tet','י':'Yod','כ':'Kaf','ך':'Kaf final','ל':'Lamed','מ':'Mem','ם':'Mem final','נ':'Nun','ן':'Nun final','ס':'Samekh','ע':'Ayin','פ':'Pe','ף':'Pe final','צ':'Tzadi','ץ':'Tzadi final','ק':'Qof','ר':'Resh','ש':'Shin','ת':'Tav'};
function gematriaSum(word){return [...word].reduce((n,ch)=>n+(gematriaValues[ch]||0),0)}
function renderGematria(){return `<div class="mini-tool gematria-tool"><label for="gematria-input">Digite um conceito em português ou uma palavra em hebraico</label><div class="mini-tool-row"><input id="gematria-input" type="text" maxlength="48" placeholder="amor" value="amor"><button id="gematria-run">Calcular ↗</button></div><div id="gematria-result" class="gematria-result" role="status" aria-live="polite"></div><small>Vocabulário selecionado: amor, um, vida, paz, luz, casa, água, fogo, terra, céu, caminho, palavra, verdade, sabedoria, beleza, rei. Para outras palavras, digite em hebraico.</small></div>`}
function bindGematria(){const input=$('#gematria-input'),button=$('#gematria-run'),result=$('#gematria-result');if(!input||!button)return;const run=()=>{const raw=input.value.trim(),known=hebrewWords.find(w=>norm(w.pt)===norm(raw)||w.he===raw),he=known?.he||(/^[א-ת\s]+$/.test(raw)?raw.replace(/\s/g,''):null);if(!he){result.innerHTML='<p>Não há tradução revisada para esta palavra no glossário. Escolha um termo da lista ou digite a grafia hebraica.</p>';return}const letters=[...he].map(ch=>({ch,name:hebrewLetterNames[ch],value:gematriaValues[ch]})),sum=gematriaSum(he),matches=hebrewWords.filter(w=>w.he!==he&&gematriaSum(w.he)===sum);result.innerHTML=`<div class="gematria-translation"><span>${esc(raw)} →</span><strong lang="he" dir="rtl">${esc(he)}</strong><span>${known?`(${esc(known.read)} · ${esc(known.sense)})`:'(grafia hebraica informada)'}</span></div><div class="gematria-letters" dir="rtl">${letters.map(l=>`<div><strong lang="he">${l.ch}</strong><span>${esc(l.name)}</span><b>${l.value}</b></div>`).join('')}</div><div class="gematria-sum">${letters.map(l=>l.value).join(' + ')} <b>= ${sum}</b></div><p class="gematria-match">${matches.length?`Mesmo valor no glossário: ${matches.map(w=>`<b>${esc(w.sense)} · <span lang="he">${w.he}</span> (${w.read})</b>`).join('; ')}.`:'Nenhuma outra palavra do glossário tem esta soma.'} A igualdade é uma pista interpretativa; não torna os significados idênticos.</p>`};button.onclick=run;input.onkeydown=e=>{if(e.key==='Enter'){e.preventDefault();run()}};run()}
function deckDetail(i){const items=[
 {title:'O Mago · Marselha',body:'<p>Nos baralhos de Marselha, uma tradição gráfica consolidada entre os séculos XVII e XVIII, o Mago aparece como figura de mesa. Os objetos se oferecem como recursos de ação, ofício e atenção. Olhe a disposição antes de atribuir uma intenção.</p><p><b>Compare:</b> o gesto é mais contido que no Waite–Smith; a mesa se destaca mais que a rede geométrica do Thoth.</p><p><b>Para escrever:</b> que ferramenta um personagem tem diante de si, mas ainda não decidiu usar?</p>',links:[{title:'The Metropolitan Museum of Art – história do tarô',url:'https://www.metmuseum.org/perspectives/tarot-2'}]},
 {title:'O Mago · Waite–Smith',body:'<p>Publicado em 1909, o baralho foi concebido por Arthur Edward Waite (1857–1942) e desenhado por Pamela Colman Smith (1878–1951). No Mago, a figura ergue um braço, aponta o outro para baixo e dispõe os quatro símbolos dos naipes sobre a mesa. Jardim e gesto organizam a ideia de mediação.</p><p><b>Compare:</b> a cena é mais ritualizada que no Marselha e mais figurativa que no Thoth.</p><p><b>Para escrever:</b> o que uma personagem tenta trazer da intenção à prática?</p>',links:[sources.britishSmith]},
 {title:'O Mago · Thoth',body:'<p>No Tarot de Thoth, pintado por Lady Frieda Harris (1877–1962) com o sistema de Aleister Crowley (1875–1947), o Mago se liga à letra Beth e a Mercúrio. Movimento, cor e objetos em órbita substituem a cena estável da mesa por uma composição dinâmica.</p><p><b>Compare:</b> os três baralhos mantêm recursos de ação, mas aqui circulação e linguagem ganham intensidade.</p><p><b>Para escrever:</b> que mensagem muda o curso da cena antes mesmo de uma ação física?</p>',links:[sources.crowleyMagician]}
 ];const d=items[i];if(d)openKnowledge(d.title,d.body,d.links,'TRÊS MAGOS · COMPARAÇÃO')}
function suitDetail(code){const data={W:['Paus · Fogo','impulso, vontade e iniciativa','O Dez de Paus pode se tornar Opressão: energia acumulada como peso.'],C:['Copas · Água','afeto, receptividade e vínculo','O Dois de Copas recebe o título Amor: uma troca que precisa circular.'],S:['Espadas · Ar','pensamento, linguagem e conflito','O Dez de Espadas se chama Ruína: a força mental acumulada rompe sua própria estrutura.'],D:['Discos · Terra','corpo, matéria e recursos','O Dez de Discos se chama Riqueza: recursos podem alcançar forma e estabilidade.']}[code];if(!data)return;const [title,meaning,example]=data;openKnowledge(title,`<p>No Tarot de Thoth, este naipe corresponde ao elemento que sugere <b>${meaning}</b>. A carta mostrada é um Dois: o número 2 ocupa Chokmah, uma mesma posição da Árvore nos quatro naipes.</p><p>${example} Compare Dez de Discos e Dez de Espadas: ambos chegam a Malkuth, mas Terra pode consolidar enquanto Ar pode exaurir uma tensão. Isso não transforma todas as cartas de um naipe em “boas” ou “más”.</p><p><b>Para escrever:</b> o que muda na mesma situação quando ela é vivida como vontade, afeto, conflito ou recurso?</p>`,[sources.crowleySuits,sources.crowleyNumbers],'NAIPE · ELEMENTO · NÚMERO');window.ArcanaTree.related(['02','10'].map(r=>`${code}-${r}`))}
function bindSandbox(){const letter=$('#sandbox-letter'),sephirah=$('#sandbox-sephirah'),element=$('#sandbox-element'),planet=$('#sandbox-planet'),result=$('#sandbox-result');if(!letter||!result)return;const suitMap={Fogo:'W','Água':'C',Ar:'S',Terra:'D'};const render=()=>{const ix=letter.value,sp=sephirah.value,el=element.value,pl=planet.value,codes=[];if(sp)for(const suit of ['W','C','S','D'])codes.push(`${suit}-${+sp===1?'0A':String(sp).padStart(2,'0')}`);if(ix!=='')codes.push(`T-${String(paths[+ix][3]).padStart(2,'0')}`);if(el)for(const r of ['02','10'])codes.push(`${suitMap[el]}-${r}`);if(pl)majors.forEach((m,i)=>{if(m[1]===pl)codes.push(`T-${String(i).padStart(2,'0')}`)});const unique=[...new Set(codes)];result.innerHTML=`<p>${unique.length?`${unique.length} carta${unique.length===1?'':'s'} relacionada${unique.length===1?'':'s'} às escolhas. Clique para ver imagem e explicação.`:'Escolha uma ou mais relações. As cartas aparecem aqui com explicação; combinações sem carta comum continuam úteis como contraste de escrita.'}</p><div class="sandbox-cards">${unique.map(code=>{const img=mediaCard(code);return `<button type="button" data-card="${code}" title="${esc(cardName(code))}">${img?`<img src="${esc(img)}" alt="">`:''}<span>${esc(cardName(code))}</span></button>`}).join('')}</div><button type="button" class="sandbox-explain">Explicar esta combinação ↗</button>`;result.querySelector('.sandbox-explain').onclick=()=>{openKnowledge('Sua combinação',`<p><b>Letra/caminho:</b> ${ix!==''?`${esc(paths[+ix][0])} · ${esc(majorNames[paths[+ix][3]])}`:'não selecionado'}. <b>Sephirah:</b> ${sp?`${esc(sefirot[+sp-1][0])} · número ${sp}`:'não selecionada'}. <b>Elemento:</b> ${esc(el||'não selecionado')}. <b>Planeta:</b> ${esc(pl||'não selecionado')}.</p><p>Uma carta pode aparecer por mais de uma associação. Se as escolhas apontam para cartas diferentes, compare as imagens e formule uma tensão: o que cada símbolo pede à mesma personagem? A composição é um exercício de escrita, não uma atribuição histórica nova.</p>`,[sources.crowleyTree,sources.crowleyPaths,sources.crowleySuits],'LABORATÓRIO · RELAÇÕES');window.ArcanaTree.related(unique)};result.querySelectorAll('[data-card]').forEach(b=>b.onclick=()=>window.ArcanaTree.showCard(b.dataset.card,b))};[letter,sephirah,element,planet].forEach(x=>x.onchange=render);render()}
...
if(key.includes('gematria')||key.includes('translit')){body='<p>Gematria atribui valores numéricos às letras de palavras hebraicas. A conta depende da grafia escolhida: אהבה (amor) soma 13 e אחד (um) também soma 13.</p><p>O exemplo da oficina usa traduções selecionadas e mostra cada letra. Soma igual propõe uma comparação interpretativa; não afirma que as palavras tenham o mesmo significado.</p>';links=[sources.mathers,sources.scholem]}
...
else if(key.includes('crowley')||key.includes('harris')||key.includes('frieda')){body='<p>Aleister Crowley (1875–1947) reorganizou correspondências da Golden Dawn em seu sistema de tarô. Lady Frieda Harris (1877–1962) pintou as cartas do Thoth entre 1938 e 1943 a partir de suas orientações.</p><p>O baralho permite observar as relações entre imagem, texto e correspondências. A familiaridade com qualquer deck ajuda a notar detalhes e mudanças entre cartas.</p>';links=[sources.cambridge,sources.crowleyTitle,sources.warburg]}
...
$$('[data-view="login"]').forEach(x=>x.onclick=()=>setAuthMode('login'));$$('[data-view="request"]').forEach(x=>x.onclick=()=>setAuthMode('request'));$$('[data-view="welcome"]').forEach(x=>x.onclick=()=>visible('welcome'));$('#auth-switch').onclick=()=>setAuthMode(state.authMode==='reset'?'login':'reset');
...
$('#slide').addEventListener('keydown',e=>{const path=e.target.closest('[data-path]');if(path&&(e.key==='Enter'||e.key===' ')){e.preventDefault();window.ArcanaTree.showInfo('letter',+path.dataset.path)}});
$('#slide').addEventListener('click',e=>{const deck=e.target.closest('[data-deck]');if(deck){deckDetail(+deck.dataset.deck);return}const suit=e.target.closest('[data-suit]');if(suit){suitDetail(suit.dataset.suit);return}const path=e.target.closest('[data-path]');if(path){window.ArcanaTree.showInfo('letter',+path.dataset.path);return}const origin=e.target.closest('[data-origin]');if(origin){detailForSlide(origin.dataset.origin==='history'?5:4);return}const goto=e.target.closest('[data-goto]');if(goto){state.idx=+goto.dataset.goto;showSlide();return}const t=e.target.closest('[data-knowledge]');if(t){knowledgeFromTerm(t.dataset.knowledge,t.dataset.tag);return}const d=e.target.closest('[data-open-detail]');if(d)detailForSlide(+d.dataset.openDetail)});
